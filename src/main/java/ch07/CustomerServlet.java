...
public class CustomerServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		for (Customer c : list)
			...
			.append("<td>").append("<a href=\"/ch07/updateCustomer?uid=").append(c.getUid()).append("\">수정</a>").append("</td>")
			.append("<td>").append("<a href=\"/ch07/deleteCustomer?uid=").append(c.getUid()).append("\">삭제</a>").append("</td>")
			.append("</tr>");
		...
		out.print("</table>");
		out.print("<br>");
//		out.print("<a href=\"/ch07/registerCustomer.html\">회원가입</a>");
		out.print("</body>");
		out.print("</html>");
